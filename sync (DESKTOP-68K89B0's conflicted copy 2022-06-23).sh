...
#echo "172.20.74.65"
#rsync shaohua@172.20.74.65:denoising-diffusion-pytorch/results/'*png' $ROOT/denoising/74.65-clsinterp-tea-geo-bs128/ -aic  2>&1|grep -E "fcstp|f\\+\\+"
echo "172.20.117.215"
...
echo "10.2.18.254-1"
rsync li_shaohua@10.2.18.254:denoising-diffusion-pytorch/results/'*png' $ROOT/denoising/18.254-clsinterp-tea-geo-bs96/ -aic  2>&1|grep -E "fcstp|f\+\+"
#echo "10.2.18.254-2"
