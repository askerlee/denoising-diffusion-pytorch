...
rsync shaohua@172.20.74.65:denoising-diffusion-pytorch/results/interp/'*png' $ROOT/denoising/74.65-clsinterp2-tea-geo-bs96/interp/ -aic  2>&1|grep -E "fcstp|f\\+\\+"
rsync shaohua@172.20.74.65:denoising-diffusion-pytorch/results/single/'*png' $ROOT/denoising/74.65-clsinterp2-tea-geo-bs96/single/ -aic  2>&1|grep -E "fcstp|f\\+\\+"
echo "172.20.117.215"
...
rsync li_shaohua@10.2.18.254:denoising-diffusion-pytorch/results/interp/'*png' $ROOT/denoising/18.254-gtinterp1-tea-bs96/interp/ -aic  2>&1|grep -E "fcstp|f\\+\\+"
rsync li_shaohua@10.2.18.254:denoising-diffusion-pytorch/results/single/'*png' $ROOT/denoising/18.254-gtinterp1-tea-bs96/single/ -aic  2>&1|grep -E "fcstp|f\\+\\+"
#echo "10.2.18.254-2"
