...
echo "172.20.74.65"
rsync shaohua@172.20.74.65:denoising-diffusion-pytorch/results/'sample*png' $ROOT/denoising/74.65-pokemon-int0.001-tea-mem4k/ -aic  2>&1|grep -E "fcstp|f\\+\\+"
echo "10.2.18.238"
...
echo "10.2.18.254-1"
rsync li_shaohua@10.2.18.254:denoising-diffusion-pytorch/results/'sample*png' $ROOT/denoising/18.254-pokemon-tea-mem4k/ -aic  2>&1|grep -E "fcstp|f\+\+"
echo "10.2.18.254-2"
