...
echo "172.20.117.215"
rsync -r shaohua@172.20.117.215:denoising-diffusion-pytorch/samples/ $ROOT/denoising/117.215-pok-interpvit2-tea/ -aic 2>&1|grep -E "fcstp|f\\+\\+"
#echo "10.2.18.238"
...
echo "A100-1"
rsync -r shaohua@172.20.117.175:denoising-diffusion-pytorch/samples/ $ROOT/denoising/A100-flower-interpvit2-tea-bs64/ -aic  2>&1|grep -E "fcstp|f\+\+"
echo "A100-2"
