...
echo "172.20.117.215"
rsync shaohua@172.20.117.215:denoising-diffusion-pytorch/results/'*png' $ROOT/denoising/117.215-pok-interp-imgnorm2-tea/ -aic 2>&1|grep -E "fcstp|f\\+\\+"
#echo "10.2.18.238"
...
echo "10.2.18.254-1"
rsync li_shaohua@10.2.18.254:denoising-diffusion-pytorch/results/'*png' $ROOT/denoising/18.254-interp-imgnorm2-tea-bs96/ -aic  2>&1|grep -E "fcstp|f\+\+"
#echo "10.2.18.254-2"
